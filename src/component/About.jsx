...
const About = () => {
  return (
    ...
    <div className="text-lg font-technor">
    ...
    <section>
      <h2 className="text-purple-500 text-left text-xl mb-4 "> ABOUT ME</h2>
      <h3 className="font-bold text-left text-white text-lg mb-2">Olayinka D. Adeyefa</h3>
      <p className="max-w-2xl text-left text-white text-sm leading-relaxed font-technor">
    ...
    <section className="max-w-2xl">
      <p className="mb-4 text-left text-xl font-technor">I can comfortably contribute to projects with my knowledge and provable experience in the following fields:</p>
      ...
      <p className="text-xs text-left text-black mt-4">
